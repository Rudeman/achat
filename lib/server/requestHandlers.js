    ...
    database.runQuery(query, function(error,records) {
        ...
        var body = '<html>'+
            ...
            'Attachemnt:<t/> <select name="attachment">'+
                ...
                '<option value="/assets/images/avatars/ashamed-woman.jpg">Attachment 1</option>'+
                '<option value="/assets/images/avatars/test.jpg">Attachment 2</option>'+
                '<option value="/assets/images/avatars/noAvatar.png">Attachment 3</option>'+
            '</select><br/>'+
